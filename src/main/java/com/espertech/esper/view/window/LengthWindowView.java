...
public class LengthWindowView extends ViewSupport implements DataWindowView, CloneableView
{
    ...
    protected final ArrayDeque<EventBean> events = new ArrayDeque<EventBean>();  //每个事件的存储结构  一个ArrayDeque
    ...
    public final void update(EventBean[] newData, EventBean[] oldData)
    {
        ...
        int expiredCount = events.size() - size;   //如此更新每个window，在初始化的时候有一个window的策略。
