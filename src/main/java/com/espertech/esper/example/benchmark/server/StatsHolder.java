...
//�÷������Եõ����?���̰߳�ȫ�����׵��̰߳�ȫ��״̬������Ҫע�� �����̰߳�ȫ����ָ�������ֱ��ʹ�����ṩ�ĺ�����磺queue.add(obj); 
    private static ThreadLocal<Stats> statsEngine = new ThreadLocal<Stats>() {//ThreadLocal������һ��Thread������Thread�ľֲ�����
        protected synchronized Stats initialValue() {//����synchronized�����м�������ͬ��
    ...
    public static void dump(String name) {
        Stats sum = null;
        for (Stats s : STATS) {//J2SE 1.5�У���������һ����ʽ��forѭ��������������ʽ��forѭ�������ڿ�����һ�ָ�򵥵ط�ʽ�����б���Ĺ�����for (ѭ���������� ѭ��������� : Ҫ������Ķ���) ѭ����
