 ...
 */
public class MarketData implements InTime{

    public final static int SIZE = Symbols.SIZE + Double.SIZE + Integer.SIZE + Long.SIZE + Country.SIZE;
    static {
    ...
    public MarketData(String ticker, double price, int volume, String country) {
        this();
        this.ticker = ticker;
        this.price = price;
        this.volume = volume;
    ...
    public static MarketData fromByteBuffer(ByteBuffer byteBuffer) {
        ...
        char[] country = new char[Country.LENGTH];
        cb.get(country);
        md.setCountry(String.valueOf(country));
        //price, volume
    ...
    public String toString() {
        return ticker+" : "+time+" : "+price+" : "+volume+" : "+country;
    }

    public Object clone() throws CloneNotSupportedException {
        return new MarketData(ticker, price, volume, country);
    }
}
