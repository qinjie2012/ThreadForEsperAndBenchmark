...
public class Server extends Thread {
    ...
    public static final int DEFAULT_QUEUEMAX = 10;
    ...
    public synchronized void start() {
        ...
        if (queueMax < 0) {
            ...
            BlockingQueue<Runnable> queue;//�߳�����
            if (queueMax == 0) {
                queue = new SynchronousQueue<Runnable>(true);//��һ���ʹ������̣߳�����Ϊ0
            } else {
                queue = new LinkedBlockingQueue<Runnable>(queueMax);//���е���ĿλqueueMax
            }
    ...
    public void runServer() {
        try {
            ...
            do {
                ...
                ClientConnection a=new ClientConnection(socketChannel, executor, cepProvider, statSec);
    ...
    public void runSimulation() {
        ...
        //A thread started by the Server when running in simulation mode. It acts as ClientConnection
