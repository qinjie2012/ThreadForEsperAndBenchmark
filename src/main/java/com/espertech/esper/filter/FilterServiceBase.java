...
public abstract class FilterServiceBase implements FilterServiceSPI
{
    ...
    private volatile long filtersVersion = 1;   //始终递增！
    ...
    protected FilterServiceEntry addInternal(FilterValueSet filterValueSet, FilterHandle filterCallback)   //关联到sendEvent过程中的version的更改变化
    {
    ...
    private void retryableMatchEvent(EventBean theEvent, Collection<FilterHandle> matches) {
        ...
        catch (FilterLockBackoffException ex) { //filterLock的作用是什么     
