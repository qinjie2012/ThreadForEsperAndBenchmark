...
public class ResultSetProcessorAggregateGroupedOutputLastHelper {
    ...
    public void processView(EventBean[] newData, EventBean[] oldData, boolean isGenerateSynthetic) {
        ...
        if (processor.prototype.isSelectRStream()) {
            processor.generateOutputBatchedView(oldData, oldDataMultiKey, false, isGenerateSynthetic, outputLastUnordGroupOld, null);
        }
        processor.generateOutputBatchedView(newData, newDataMultiKey, false, isGenerateSynthetic, outputLastUnordGroupNew, null);
    }
    ...
    public void processJoin(Set<MultiKey<EventBean>> newData, Set<MultiKey<EventBean>> oldData, boolean isGenerateSynthetic) {
        ...
        if (processor.prototype.isSelectRStream()) {
            processor.generateOutputBatchedJoin(oldData, oldDataMultiKey, false, isGenerateSynthetic, outputLastUnordGroupOld, null);
        }
        processor.generateOutputBatchedJoin(newData, newDataMultiKey, false, isGenerateSynthetic, outputLastUnordGroupNew, null);
    }
